...
from evaluation.sample_from_model import sample_from_model
from utils.training_args import out_to_updated_args
from evaluation.recreate_model import recreate_model
...
def get_args():
    ...
    parser.add_argument('-si', '--save_interval_', type=int, default=10000,
                        help='How often to save a snapshot of our samples')
...
if __name__ == "__main__":
    ...
    with tf.Session() as sess:
        ...
        for i in range(args.num_batches_):
            ...
            batches.append(sample_from_model(sess, obs_shape, new_x_gen, xs, args.batch_size_, args.nr_gpu_))
