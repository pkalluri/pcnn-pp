...
class DataLoader(object):
    ...
    def __init__(self, data_dir, which_class, subset, batch_size, rng=None, shuffle=False, return_labels=False):
        """ 
...
if __name__ == "__main__":
    batch_size = 16
    nr_gpu = 8
    train_data = DataLoader('../../data', 0, 'train', batch_size * nr_gpu, rng=None, shuffle=True, return_labels=True)
